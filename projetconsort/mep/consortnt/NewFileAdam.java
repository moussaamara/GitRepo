...
public class NewFileAdam {
	...
	public String toString() {
		return livrable + ";" + type + ";" + dateHeure + ";" + commentaire
				+ ";" + DropsOuiNon + ";" + releaseDrops + ";"
				+ envtProcessDrops + ";" + dI + ";" + pA + ";" + cpi + ";"
				+ cpiBackup + ";" + sitesDeDeploiement + ";" + iDConstructeur;
	}
